...
class Shapely_Important_Links extends WP_Customize_Control {
   ...
   public function render_content() {?>
        ...
        <div class="inside">
            ...
            <p><b><a href="http://colorlib.com/wp/support/shapely"><?php _e('Shapely Documentation','shapely'); ?></a></b></p>
            ...
            <ul>
                <li><a class="button" href="http://wordpress.org/support/view/theme-reviews/shapely?filter=5" title="<?php esc_attr_e('Rate this Theme', 'shapely'); ?>" target="_blank"><?php printf(__('Rate this Theme','shapely')); ?></a></li>
                <li><a class="button" href="http://www.facebook.com/colorlib" title="Like Colorlib on Facebook" target="_blank"><?php printf(__('Like on Facebook','shapely')); ?></a></li>
                <li><a class="button" href="http://twitter.com/colorlib/" title="Follow Colrolib on Twitter" target="_blank"><?php printf(__('Follow on Twitter','shapely')); ?></a></li>
            </ul>
        </div><?php
   }
