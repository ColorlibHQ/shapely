 ...
 *
 * The demo is captured live from https://colorlibhub.com/shapely/, so this needs a network connection and
...
const DEMO = 'https://colorlibhub.com/shapely/';
...
<style>
  ...
  *{margin:0;padding:0;box-sizing:border-box}
  ...
  .card{position:relative;width:1280px;height:640px;background:#001c28;overflow:hidden}
  ...
  .glow{position:absolute;left:-300px;top:-340px;width:940px;height:940px;border-radius:50%;
        background:radial-gradient(circle,rgba(116,92,249,.34) 0%,transparent 62%)}
  ...
  .mark{width:52px;height:52px;border-radius:15px;background:#745cf9;
        display:grid;place-items:center;color:#fff;font-size:26px;font-weight:700;
        box-shadow:0 8px 24px rgba(116,92,249,.34)}
  ...
  h1 i{font-style:normal;color:#a798ff;display:block}
  ...
  .chip--on{border-color:#745cf9;color:#a798ff;background:rgba(116,92,249,.34)}
...
<div class="card">
  ...
  <div class="body">
    <div class="brand"><div class="mark">S</div><b>Shapely</b></div>
    <h1>A one-page<i>WordPress theme</i></h1>
    <p>Full-screen hero, section-based homepage widgets, portfolio and testimonials — built for business and landing pages.</p>
    <div class="chips"><span class="chip chip--on">Free &amp; GPLv3</span><span class="chip">One-page layout</span><span class="chip">WooCommerce ready</span></div>
  </div>
  <div class="shot"></div>
</div>`;
